...
const step1Desktop = document.getElementById('step-1-desktop');
const step1Mobile = document.getElementById('step-1-mobile');
const step1Logo = document.getElementById('step-1-logo');
...
step1Desktop.addEventListener('click', openModalUploadDesktop);
step1Mobile.addEventListener('click', openModalUploadMobile);
step1Logo.addEventListener('click', openModalUploadLogo);
...
btnSendImageDesktop.addEventListener('click', () => {
    ...
    if (file) {
        ...
        step1Desktop.style.display = 'none';
...
btnSendImageMobile.addEventListener('click', () => {
    ...
    if (file) {
        ...
        step1Mobile.style.display = 'none';
...
sendInputDesktop.addEventListener('change', () => {
    const file = sendInputDesktop.files[0];
    if (file) {
        //showImage(file, imagePreviewDesktop);
        openConfirmModalDesktop();
        uploadedImageDesktop.value = file.name
        closeModalUploadDesktop();
    }
